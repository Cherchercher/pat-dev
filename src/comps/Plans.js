...
class Plans extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      city: "",
      bbox: null,
      startDate: new Date(Date.now().getDate() + 1000 * 60 * 60 * 24),
      endDate: new Date(Date.now().getDate() + 1000 * 60 * 60 * 48),
      mounted: false,
      tags: [],
      suggestions: [],
      spend: 0,
          ...
          activities: [
            {
              ...
              rating: 0,
              tags: [],
              startTime: new Date(Date.now().getDate() + 1000 * 60 * 60 * 32),
              endTime: new Date(Date.now().getDate() + 1000 * 60 * 60 * 42),
            },
          ],
        },
      ],
          ...
          <div style={styles.tapDisplay}>
            ...
            >
              ...
              <TabPanel value={this.state.tabValue} index={1} dir={"ltr"}>
                <p>No Plans yet </p>
                <Button variant="primary">Invite Friends to Plan A Trip</Button>
                <p> suggestions</p>
              </TabPanel>
